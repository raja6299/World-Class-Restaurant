...
export default function ReservationFormSection() {
  ...
  return (
    <section id="reservation" className="py-24 px-6 lg:px-12 bg-aurum-cream-secondary">
      ...
      >
        {/* Ambiance Image */}
        <div className="relative h-[600px] w-full rounded-xl overflow-hidden shadow-aurum-lg hidden lg:block">
          <AnimatedImage
            src="/images/reservation_ambiance.webp"
            alt="Intimate romantic dining table for two in a luxury Indian restaurant"
            fill
